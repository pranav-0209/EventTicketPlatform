...
import com.pranav.tickets.exceptions.EventNotFoundException;
import com.pranav.tickets.exceptions.EventUpdateException;
...
public class EventServiceImpl implements EventService {
    ...
    public Event updateEventForOrganizer(UUID organizerId, UUID id, UpdateEventRequest event) {
        ...
        if (!id.equals(event.getId())) {
            throw new EventUpdateException("Cannot Update the ID of an event. Event IDs don't match");
        }
